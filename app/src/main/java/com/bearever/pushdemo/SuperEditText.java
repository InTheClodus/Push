...
public class SuperEditText extends AppCompatEditText {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        // 原理：通过 反射机制 动态设置光标
        // 1. 获取资源ID
        cursor = typedArray.getResourceId(R.styleable.SuperEditText_cursor, R.drawable.ic_launcher_background);
        try {
        ...
        if (ed_bg) {
            ...
            // 1. 获取资源ID
            ic_deleteResID = typedArray.getResourceId(R.styleable.SuperEditText_ic_delete, R.drawable.ic_launcher_background);
            ...
            delete_width = typedArray.getInteger(R.styleable.SuperEditText_delete_width, 50);
            delete_height = typedArray.getInteger(R.styleable.SuperEditText_delete_height, 50);
            ...
            // a. 点击状态的左侧图标
            // 1. 获取资源ID
            ic_left_clickResID = typedArray.getResourceId(R.styleable.SuperEditText_ic_left_click, R.drawable.ic_launcher_background);
            // 2. 根据资源ID获取图标资源（转化成Drawable对象）
            ...
            left_height = typedArray.getInteger(R.styleable.SuperEditText_left_height, 80);
            ...
            // b. 未点击状态的左侧图标
            // 1. 获取资源ID
            ic_left_unclickResID = typedArray.getResourceId(R.styleable.SuperEditText_ic_left_unclick, R.drawable.ic_launcher_background);
            // 2. 根据资源ID获取图标资源（转化成Drawable对象）
        ...
        int lineColorClick_default = context.getResources().getColor(R.color.colorAccent); // 默认 = 蓝色#1296db
